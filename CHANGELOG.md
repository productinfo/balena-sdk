...
* Chore: Run paid user tests on appveyor [Thodoris Greasidis]
* Chore: Drop travis tests [Thodoris Greasidis]
* Tests: Create random test user when no env vars are present [Thodoris Greasidis]
